...
@Table(name="funeral")
@NamedQueries({
	@NamedQuery(name = "Funeral.getFuneralsByGraveIdOwnerId",
				query = "select r from Grave g "+
						"join g.funerals r "+
						"join r.deceased d "+
						"where g.id = :graveId AND d.id = :deceasedId")
})
public class Funeral implements Serializable{

	private static final long serialVersionUID = -6219823526304589033L;
